...
<body>
    ...
    <div class="container">
        ...
        <a class="navbar-brand" href="">FavoriteSongs&copy;</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <button class="btn btn-outline-danger my-2 my-sm-0"><a href="index.php" style="text-decoration: none; color: red;">SAIR</a></button>
            </form>
        </div>
        </nav>
        <img src="imagens/capa.png" class="img-fluid" alt="Imagem responsiva">
        <hr>
