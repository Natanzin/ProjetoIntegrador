<?php include_once "../template/cabecalho.php"; ?>
            ...
            $idPlay = $_GET['id'];
                ...
                join playlist p on mp.id_playlist = p.id_playlist where m.id_usuario = '{$_SESSION['id_user']}' and mp.id_playlist = '$idPlay'";
                        ...
                        <div class='col'>
                            <div class='card border-primary' style='width:15rem; background: rgba(50, 153, 204, 0.3);'>
                                ...
                                <div class='card-body'>
                                    ...
                                    <a href='../functionsPHP/processamentos/excluirMusicaPlaylist.php?idMsc={$musica['id_musica']}&&idPlay={$musica['id_playlist']}' class='card-link text-danger font-weight-bold'>X excluir da playlist</a>
                                </div>
                            </div>
                        </div>
                    ";
